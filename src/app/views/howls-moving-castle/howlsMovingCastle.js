...
import "./howlsMovingCastle.css";
import { useHistory } from "react-router-dom";
import { motion } from "framer-motion";
import moviePoster from './howls.jpg';

function HowlsMovingCastle({movie, setMovie}){
    ...
    function renderMovie(){
        ...
        return(
            <div>
               <h1 className="title-howls">{ movieName }</h1>
            </div>
        )
    }
    ...
    function DisplayPoster(){
        return (
            ...
            className="display-card">
            <img src={moviePoster} alt="Movie Poster" className="howls-poster"/>
            </motion.div>
        );
    }
    ...
    return (
        <div className="howls-moving-castle">
            {renderMovie()}
