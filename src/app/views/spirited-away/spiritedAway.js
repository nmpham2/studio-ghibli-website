...
import moviePoster from './spirited-away.jpg';

function SpiritedAway({movie, setMovie}){
    ...
    function renderMovie(){
        ...
        return(
            <div>
               <h1 className="title-spirited">{ movieName }</h1>
            </div>
        )
    }
    ...
    function DisplayPoster(){
        return (
            ...
            className="display-card">
            <img src={moviePoster} alt="Movie Poster" className="spirited-poster"/>
            </motion.div>
        );
    }
