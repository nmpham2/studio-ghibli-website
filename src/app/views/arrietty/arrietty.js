...
import moviePoster from "./arrietty.png";

function Arrietty({movie, setMovie}){
    ...
    function renderMovie(){
        ...
        return(
            <div>
               <h1 className="title-arrietty">{ movieName }</h1>
            </div>
        )
    }
    ...
    function DisplayPoster(){
        return (
            ...
            className="display-card">
            <img src={moviePoster} alt="Movie Poster" className="arrietty-poster"/>
            </motion.div>
        );
    }
