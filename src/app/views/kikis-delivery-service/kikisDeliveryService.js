...
import "./kikisDeliveryService.css";
import { useHistory } from "react-router-dom";
import { motion } from "framer-motion";
import moviePoster from './kikis.jpg';

function KikisDeliveryService({movie, setMovie}){
    ...
    function renderMovie(){
        ...
        return(
            <div>
               <h1 className="title-kikis">{ movieName }</h1>
            </div>
        )
    }
    ...
    function DisplayPoster(){
        return (
            ...
            className="display-card">
            <img src={moviePoster} alt="Movie Poster" className="kikis-poster"/>
            </motion.div>
        );
    }
    ...
    return (
        <div className="kikis-delivery-service">
            {renderMovie()}
...
export default KikisDeliveryService;